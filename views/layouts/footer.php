...
<script type="text/javascript" src="<?php echo App::get('config')['APP_URL'] . '/public/assets/js/datatable-jquery.js' ?>"></script>
<script type="text/javascript" src="<?php echo App::get('config')['APP_URL'] . '/public/assets/js/datatable-bs.js' ?>"></script>
